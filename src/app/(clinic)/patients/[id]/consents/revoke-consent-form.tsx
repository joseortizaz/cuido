...
import { revokeConsent, type ConsentActionState } from "./actions";
...
export function RevokeConsentForm({ patientId, consentId }: { patientId: string; consentId: string }) {
  const boundAction = revokeConsent.bind(null, patientId, consentId);
